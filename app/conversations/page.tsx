      ...
      <div className="px-4 space-y-1">
        {chats.length === 0 ? (
          <div className="text-center py-20 bg-slate-50 rounded-[2.5rem] border-2 border-dashed border-slate-200/50 mx-2">
            ...
            <p className="text-[9px] text-slate-300 font-bold uppercase mt-1">Found IDs will appear here</p>
          </div>
        ) : (
          chats.map((chat) => {
            // Note: your action returns messages sorted by 'desc' for the preview
            ...
            return (
              ...
              >
                ...
                <div className="relative shrink-0">
                  ...
                  {/* FIXED: Status Indicator now only checks if lastMessage exists */}
                  {!lastMessage && (
